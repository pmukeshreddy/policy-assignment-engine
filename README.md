...
The committed [latest verified results](eval-results/latest.md) combine the accepted isolated latency and fan-out measurements with the frozen 100,000-mutation correctness, transition-conformance, and avoided-work results. The [full final metrics report](eval-results/final-submission-metrics.md) and [machine-readable artifact](eval-results/final-submission-metrics.json) record the values and their provenance.
